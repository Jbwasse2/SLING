...
def get_scenes(scenes, scanName):
    ...
    for scene in tqdm(scenes):
        ...
        if dataset == "mp3d":
            ...
            scan_name = re.match(r"([a-z]+)_([0-9]+)", scene, re.I).groups()[0]
