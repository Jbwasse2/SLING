...
## Slurm
REPO_PATH=~/sling/code/embodied_ssl
...
EXP_NAME="ddppo_best_run"
WEIGHTS_NAME="omnidata_DINO_02.pth"
BACKBONE="resnet50_gn"
EXTRA_CMDS="RL.DDPPO.pretrained_encoder False \
            RL.DDPPO.pretrained_goal_encoder False \
            RL.DDPPO.train_encoder True \
            RL.DDPPO.train_goal_encoder True \
            ${CONFIGS}"
METHOD="ddppo_sling"
CHKP_NAME="ddppo_best_run_1.pth"

for VAL_SPLIT in "gibson_curved_nrns" "matterport_straight_nrns"  "gibson_straight_nrns" "matterport_curved_nrns"
do
