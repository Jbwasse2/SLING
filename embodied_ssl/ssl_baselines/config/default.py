...
# -----------------------------------------------------------------------------
_C.RL.POLICY.OBS_AUGMENTATIONS = ""
_C.RL.POLICY.OBS_AUGMENTATIONS_PARAMS = CN()
_C.RL.POLICY.OBS_AUGMENTATIONS_PARAMS.same_on_batch = True
_C.RL.POLICY.OBS_AUGMENTATIONS_PARAMS.GRAYSCALE = CN()
_C.RL.POLICY.OBS_AUGMENTATIONS_PARAMS.GRAYSCALE.gray_p = 0.3
_C.RL.POLICY.OBS_AUGMENTATIONS_PARAMS.RANDOM_ROTATION = CN()
_C.RL.POLICY.OBS_AUGMENTATIONS_PARAMS.RANDOM_ROTATION.rotation_degrees = 5.0
_C.RL.POLICY.OBS_AUGMENTATIONS_PARAMS.RANDOM_ROTATION.rotation_p = 1.0
_C.RL.POLICY.OBS_AUGMENTATIONS_PARAMS.RANDOM_RESIZED_CROP = CN()
_C.RL.POLICY.OBS_AUGMENTATIONS_PARAMS.RANDOM_RESIZED_CROP.crop_p = 0.3
_C.RL.POLICY.OBS_AUGMENTATIONS_PARAMS.RANDOM_RESIZED_CROP.crop_size = 256
_C.RL.POLICY.OBS_AUGMENTATIONS_PARAMS.RANDOM_RESIZED_CROP.crop_scale = 0.8
_C.RL.POLICY.OBS_AUGMENTATIONS_PARAMS.RANDOM_RESIZED_CROP.crop_ratio = 1.0
_C.RL.POLICY.OBS_AUGMENTATIONS_PARAMS.COLOR_JITTER = CN()
_C.RL.POLICY.OBS_AUGMENTATIONS_PARAMS.COLOR_JITTER.color_p = 1.0
_C.RL.POLICY.OBS_AUGMENTATIONS_PARAMS.COLOR_JITTER.brightness = 0.4
_C.RL.POLICY.OBS_AUGMENTATIONS_PARAMS.COLOR_JITTER.contrast = 0.4
_C.RL.POLICY.OBS_AUGMENTATIONS_PARAMS.COLOR_JITTER.saturation = 0.4
_C.RL.POLICY.OBS_AUGMENTATIONS_PARAMS.COLOR_JITTER.hue = 0.5
_C.RL.POLICY.OBS_AUGMENTATIONS_PARAMS.TRANSLATE = CN()
_C.RL.POLICY.OBS_AUGMENTATIONS_PARAMS.TRANSLATE.pad = 4
_C.RL.POLICY.OBS_AUGMENTATIONS_PARAMS.TRANSLATE.crop_p = 1.0
_C.RL.POLICY.OBS_AUGMENTATIONS_PARAMS.TRANSLATE.crop_size = 256
# -----------------------------------------------------------------------------
...
_C.RL.PPO.lr = 2.5e-4
_C.RL.PPO.resnet_lr = 2.5e-4
_C.RL.PPO.resnet_baseplanes = 32
_C.RL.PPO.weight_decay = 0.0
_C.RL.PPO.eps = 1e-5
...
_C.RL.DDPPO.pretraining_type = "dino"
...
_C.RL.DDPPO.pretrained_goal_encoder = False
# Whether or not the goal visual encoder backbone will be trained.
_C.RL.DDPPO.train_goal_encoder = True
